...
#' An list of size four elements, containing:
#'  - 13 known therapeutic targets for prostate cancer
#'  - a named list containing gene signatures for prostate cancer
#'  - a named list of clusters calculated on the PPI subnetwork of A3LNetwork.
#'  - the same list of precalculated clusters converted to gene SYMBOL.
#' \describe{
